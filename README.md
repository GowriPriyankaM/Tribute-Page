...
7. **Create a Pull Request :** Once your changes are pushed to your forked repository, You should see a message suggesting you create a pull request on your repository on GitHub. Click on the "Compare & pull request" button to start the process.

Provide a clear title and description for your pull request, explaining the changes you've made. If there are any relevant issues or discussions, reference them in your pull request and submit it.
